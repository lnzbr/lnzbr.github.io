...
const firebaseConfig = {
  ...
  projectId: "bolao-da-lenze",
  storageBucket: "bolao-da-lenze.firebasestorage.app",
  messagingSenderId: "1007683446188",
  appId: "1:1007683446188:web:e3b9fd87db160afd198609"
};
...
const nomesJogos = [
  ...
  "Costa do Marfim x Noruega", "França x Suécia", "México x Equador", "Inglaterra x 3EHIJK",
  "Bélgica x 3AEHIJ", "EUA x Bósnia e Herzegovina", "Espanha x 2J", "2K x Croácia",
  "Suíça x 3EFGIJ", "Austrália x Egito", "Argentina x Cabo Verde", "1K x Gana"
];
...
document.getElementById('btn-gerar').addEventListener('click', async () => {
  ...
  const bilheteId = "LENZE" + Math.random().toString(36).substring(2, 6).toUpperCase();
  const pacoteDados = {
